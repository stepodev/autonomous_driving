	...
	\label{tests}
		...
		\label{test_cases}
			...
			\label{node_radiergummi}
				...
				\paragraph{Input} bla
				\begin{itemize}
					\item \textbf{A-Wert:} \emph{vehicle\_id = 1}
					\item \textbf{B-Wert:} \emph{remote\_speed = 2}
					\item \textbf{C-Wert:} \emph{remote\_angle = 3}
					\item \textbf{D-Wert:} \emph{emergency\_stop = false}
				\end{itemize}
