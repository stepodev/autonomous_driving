...
\part{Produktdokumentation}
	...
	\label{sw_architektur}
		...
		Das Systemumfeld ist auf der einen Seite die Kommunikation per Nachrichten des Platooningprotokolls und auf der anderen Seite die Kommunikation mit dem STM board aus welchen Sensornachrichten kommen und in welches Fahrkommandos geschickt werden.

 		\includegraphics[width=\textwidth]{systemumfeld.png}
