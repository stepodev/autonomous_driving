...
roslaunch platooning_sim sim_2cars.lauch
	...
	\label{hw_architektur}
		...
		Die bebilderte Anleitung zum Fahrzeugzusammenbau befindet sich im Anhang.
...
\section{Fahrzeugbau}
	...
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{teilelistekabel.pdf}
	\subsection{Teileliste Schrauben}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{teilelisteschrauben.pdf}
	\subsection{Teileliste Kabel}
	\subsubsection{Stoßfänger und Ultraschallsensor}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{stossfaenger.pdf}
	\subsubsection{Vordere Halterung und Kamerahalterung}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{kamerahalterung.pdf}
	\subsubsection{Hintere Halterung}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{hinterehalterung.pdf}
	\subsubsection{Montage Metall-Board}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{metallboard.pdf}
	\subsubsection{Sensormontage Hinterräder}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{radsensor.pdf}
	\subsubsection{Verkabelung}
	\lstset{style=customcpp,inputpath=./fahrzeugbau}
	\lstinputlisting[caption={}]{verkabelung.pdf}
