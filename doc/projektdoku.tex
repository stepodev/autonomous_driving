...
\part{Produktdokumentation}
	...
	\label{tests}
		...
		\label{test_cases}
			\subsection{Node Radiergummi}
			\label{node_radiergummi}
				\subsubsection{Test A}
				\paragraph{Aufgabe} blablabla.
				\paragraph{Input} bla
				\begin{itemize}
					\item \textbf{A-Wert:} \emph{vehicle_id = 1}
					\item \textbf{B-Wert:} \emph{remote_speed = 2}
					\item \textbf{C-Wert:} \emph{remote_angle = 3}
					\item \textbf{D-Wert:} \emph{emergency_stop = false}
				\end{itemize}
				\paragraph{Erwarteter Output} bla
				\begin{itemize}
					\item \textbf{A-Wert:} \emph{vehicle_id = 1}
					\item \textbf{B-Wert:} \emph{remote_speed = 2}
					\item \textbf{C-Wert:} \emph{remote_angle = 3}
			...
			\subsection{Node Prioritization}
			\label{node_prioritization}
				\subsubsection{Test Remote Control Toggle und Geschwindigkeitskontrolle}
				\paragraph{Aufgabe} Getestet wird, ob Prioritization Node auf Geschwindigkeitskontrolle durch Remote Control reagiert. Weiterhin wird überprüft, ob das Abschalten der Remote Control funktioniert.
				\paragraph{Input} Testen der Geschwindigkeitskontrolle
				\begin{itemize}
					\item \textbf{Vehicle ID:} \emph{vehicle_id = 1}
					\item \textbf{Vorgegebene Geschwindigkeit:} \emph{remote_speed = 2}
					\item \textbf{Vorgegebener Steuerungswinkel:} \emph{remote_angle = 3}
				\end{itemize}
				\paragraph{Erwarteter Output} Werte werden übernommen
				\begin{itemize}
					\item \textbf{Geschwindigkeit:} \emph{velocity = 2}
					\item \textbf{Steuerungswinkel:} \emph{steering_angle = 3}
				\end{itemize}
				\paragraph{Input} Testen des Abschaltens der Remote Control
				\begin{itemize}
					\item \textbf{Remote Control:} \emph{enable_remotecontrol = false}
					\item \textbf{Vehicle ID:} \emph{vehicle_id = 1}
					\item \textbf{Vorgegebene Geschwindigkeit:} \emph{remote_speed = 2}
					\item \textbf{Vorgegebener Steuerungswinkel:} \emph{remote_angle = 3}
				\end{itemize}
				\paragraph{Erwarteter Output} Änderungen sollen nicht übernommen werden
				\begin{itemize}
					\item \textbf{Empfang von Daten:} \emph{vehiclecontrol_received = false}
				\end{itemize} 			
							
				\subsubsection{Test Platooning Toggle und Geschwindigkeitskontrolle}
				\paragraph{Aufgabe} Getestet wird, ob Prioritization Node auf Geschwindigkeitskontrolle durch Platooning Node reagiert. Weiterhin wird überprüft, ob das Abschalten der Kontrolle durch die Platooning Node funktioniert.
				\paragraph{Input} Testen der Geschwindigkeitskontrolle
				\begin{itemize}
					\item \textbf{Vehicle ID:} \emph{vehicle_id = 1}
					\item \textbf{Leader Vehicle:} \emph{i_am_LV = false}
					\item \textbf{Follower Vehicle:} \emph{i_am_FV = true}
					\item \textbf{Inner Platoon Distance:} \emph{ipd = 1}
					\item \textbf{Platoon Speed:} \emph{ps = 1}
					\item \textbf{Platoon ID:} \emph{platoon_id = 1}
					\item \textbf{Platooning State:} \emph{platooning_state = RUNNING}
					\item \textbf{Platoon Members:} \emph{platoon_members = \{ 1, 2 \}}			
				\end{itemize}
				\paragraph{Erwarteter Output} Änderungen werden übernommen
				\begin{itemize}
					\item \textbf{Geschwindigkeit:} \emph{velocity = 3.0f} %warum???
					\item \textbf{Steuerungswinkel:} \emph{steering_angle = 0.0f} %warum???
				\end{itemize} 				

				\paragraph{Input} Testen des Abschaltens der Remote Control
				\begin{itemize}
					\item \textbf{Platooning:} \emph{enable_platooning = false}
					\item \textbf{Vehicle ID:} \emph{vehicle_id = 1}	
				\end{itemize}
				\paragraph{Erwarteter Output}  Änderungen sollen nicht übernommen werden
				\begin{itemize}
