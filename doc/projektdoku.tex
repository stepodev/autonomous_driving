...
\label{appendix:fahrzeugbau}
		...
		\includepdf[pages=1,pagecommand=\subsection{Teileliste Schrauben}, offset=0 -1.5cm, scale=0.9]{fahrzeugbau/teilelisteschrauben-neu.pdf}
		...
		\includepdf[pages=1,pagecommand=\subsection{Montage Metall-Board}, offset=0 -3cm]{fahrzeugbau/metallboard-neu.pdf}
