...
\part{Projektdokumentation}
	...
	\label{umfeld}
		...
		Zu Beginn der Projektarbeit wurde au\ss erdem eine Risikoanalyse angefertigt, vgl. dazu Anhang \ref{appendix:risikoanalyse}. 
...
\label{appendix:protokoll}
\includepdf[pages=-]{protokoll_spezifikation.pdf}

\section{Risikoanalyse}
\label{appendix:risikoanalyse}
\includepdf[pages=-]{risikoanalyse.pdf}
