...
void Moduletest_messagetypes::test_encode_decode_messages() {
	...
	try {
		...
		platooning::remotecontrolToggle decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::userInterface decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::lv_broadcast decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::fv_heartbeat decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::platooningToggle decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::remotecontrolInput decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::acceleration decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
	...
	try {
		...
		platooning::steeringAngle decmsg;
		std::string json = MessageTypes::encode_message(origmsg);
		MessageTypes::decode_json(json, decmsg);
