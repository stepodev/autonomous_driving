...
protected:
  ...
  size_t write_to_sendbuffer(const std::string &message, const int32_t &message_type);
  std::pair<std::string, int32_t> read_from_recvbuffer(size_t bytes_transferred);
