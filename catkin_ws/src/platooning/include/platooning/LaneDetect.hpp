...
#ifndef PLATOONING_LANEDETECT_HPP
#define PLATOONING_LANEDETECT_HPP
 ...
 */
  ...
  class LaneDetect : public nodelet::Nodelet {
  public:
    virtual void onInit();

    LaneDetect(ros::NodeHandle &nh, std::string &name);
...
#endif //PLATOONING_LANEDETECT_HPP
